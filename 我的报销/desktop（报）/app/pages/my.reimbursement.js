		...
		return (
			<div>
				...
				<div style={{height:41,margin: "20px 20px"}}>
					{/* <a key="1" onClick={() => {
						this.props.history.replace({ pathname: "/apply" });
						this.setState({
							visible:true
						})
					}} style={{float:"left",paddingLeft:20,marginTop:10}}>
						<Icon type="plus-square" theme="twoTone" style={{ fontSize: 16, paddingRight: 7 }} />
						<span>新增</span>
					</a> */}
					<a key="2" onClick={() => {
						this.setState({
