...
import { Layout, Icon, Drawer, Tabs, Badge, message, Empty, List, Avatar, Tooltip } from "antd";
		...
		return (
			<div>
				<Layout.Header className="workspace-header">
					<Icon type="menu-unfold" style={{ paddingRight: 10, color: "#6495ED", fontSize: "14px" }} />
					{/* <Icon type="appstore" theme="twoTone" twoToneColor="#52c41a" style={{ paddingRight: 10, fontSize: "20px" }} /> */}
					<span style={{ fontWeight: "600"}}>{this.props.pageInfo.title}</span>
					<span style={{ width: 200 }} />
					<div style={{ float: "right" }}>
						<Tooltip placement="bottom" title="显示待处理消息">
							<Badge count={this.state.unProcessMsgs.length > 0 ? <Icon type="clock-circle" style={{ color: "#f5222d" }} /> : 0}>
								<Icon
									type="schedule"
									theme="twoTone"
									style={{ fontSize: "20px" }}
						...
						<Tooltip placement="bottom" title="切换应用">
							<Icon
								type="appstore"
								theme="twoTone"
								twoToneColor="#6495ED"
						...
						<Tooltip placement="bottom" title="显示帮助信息">
							<Icon
						...
						<Tooltip placement="bottomRight" title="重新加载数据">
							<Icon
								type="reload"
